...
* Si le résultat de $ type est vrai, redirigez l'utilisateur vers l'URL d'échec s'il y en a un ou quittez sinon.

* Si le résultat de $ type est faux, redirigez l'utilisateur vers l'URL de réussite s'il y en a une ou continuez l'exécution.
...
$checker->SetFailureRedirect('https://www.mediapart.fr/');
